...
export default function MiniPlayer() {
  ...
  return (
    <div
      className="animate-slideInUpMini fixed inset-x-0 z-50 flex h-24 items-center border-t border-border/70 bg-gradient-to-r from-primary/20 to-accent/20 px-6 shadow-2xl backdrop-blur-lg transition-transform duration-300 ease-in-out md:bottom-4 md:mx-auto md:max-w-3xl md:rounded-xl"
    ...
    >
      {/* Cover Image */}
      <div
        className={`relative mr-4 size-16 overflow-hidden rounded-lg shadow-md transition-shadow group-hover:shadow-primary/30 md:mr-6 md:size-20 ${isPlaying ? 'animate-pulse' : ''}`}
      >
        <Image
